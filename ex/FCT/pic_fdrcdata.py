...
for line in totaline:
        ...
        downlpd.append(float(array[2])*900)
...
rects1 = ax.bar(ind, downdctcp, width, hatch='/',color='green',ecolor='k')
...
rects4 = ax.bar(ind+3*width, downpfabric, width,hatch="o",color='w',ecolor='k')
...
rects1 = ax.bar(ind, updctcp, width, hatch='/',color='green',ecolor='k')
rects2 = ax.bar(ind+width, upl2dct, width,hatch='//', color='r',ecolor='k')
rects3 = ax.bar(ind+2*width, uplpd, width, hatch='-',color='k',ecolor='k')
rects4 = ax.bar(ind+3*width, uppfabric,width, hatch="o",color='w',ecolor='k')
...
rects1 = ax.bar(ind, dctcp, width, hatch='/',color='green',ecolor='k')
rects2 = ax.bar(ind+width, l2dct, width,hatch='//', color='r',ecolor='k')

rects3 = ax.bar(ind+2*width, lpd, width, hatch='-',color='k',ecolor='k')

rects4 = ax.bar(ind+3*width, pfabric,width, hatch="o",color='w',ecolor='k')
