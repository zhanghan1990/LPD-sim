...
N = 6
dctcppath=basepath+"/small/DCTCP_small_fct.SEARCH"
d2tcppath=basepath+"/small/D2TCP_small_fct.SEARCH"
lpdpath = basepath+"/small/LPD_small_fct.SEARCH"
pfabricpath = basepath+"/small/pFabric_small_fct.SEARCH"
l2dctpath = basepath+"/small/L2DCT_small_fct.SEARCH"
...
rects4 = ax.bar(ind+2*width, pfabric, width,hatch='/', color='w',yerr=[downpfabric,uppfabric],ecolor='k')
