...
N = 6
dctcppath=basepath+"/large/DCTCP_large_fct.SEARCH"
d2tcppath=basepath+"/large/D2TCP_large_fct.SEARCH"
lpdpath = basepath+"/large/LPD_large_fct.SEARCH"
pfabricpath = basepath+"/large/pFabric_large_fct.SEARCH"
l2dctpath = basepath+"/large/L2DCT_large_fct.SEARCH"
...
rects4 = ax.bar(ind+3*width, pfabric, width,hatch='o', color='w',yerr=[uppfabric,downpfabric],ecolor='k')
...
#autolabel(rects3)
#autolabel(rects4)
fig.savefig("large_fct.eps",dpi=1000)
#plt.show()