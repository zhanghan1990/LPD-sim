...
Agent/TCP/FullTcp set threshold_min_ 1024000
Agent/TCP/FullTcp set threshold_max_ 2048000

set myAgent "Agent/TCP/FullTcp/Sack/LLTCP";
...
Queue/DropTail set mean_pktsize_ [expr $pktSize]
...
proc throughputTrace {file} {
 ...
 for {set i 0} {$i < $S} {incr i} {
        set alpha [$tcps($i)  set ecnhat_alpha_]
...
$ns at 1.0 "$tcps(0) advance-bytes 1048576000"
$ns at 0.0 "$tcps(1) advance-bytes 2097152000"
#$ns at 0.0 "$tcps(2) advance-bytes 314572800"
#$ns at 0.0 "$tcps(3) advance-bytes 419430400"
#$ns at 0.0 "$tcps(4) advance-bytes 524288000"
#$ns at 0.0 "$tcps(5) advance-bytes 629145600"
#$ns at 0.0 "$tcps(6) advance-bytes 734003200"
#$ns at 0.0 "$tcps(7) advance-bytes 838860800"
#$ns at 0.0 "$tcps(8) advance-bytes 943718400"
#$ns at 0.0 "$tcps(9) advance-bytes 1048576000"
