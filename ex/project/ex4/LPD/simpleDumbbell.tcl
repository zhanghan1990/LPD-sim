...
#zhanghan we set SMAX to 1G
Agent/TCP/FullTcp set S_MAX_ 1048576

set myAgent "Agent/TCP/FullTcp/Sack/LPDTCP";
...
$ns at 0.0 "$tcps(0) advance-bytes 104857600"
$ns at 0.0 "$tcps(1) advance-bytes 209715200"
