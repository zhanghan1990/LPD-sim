...
set myAgent "Agent/TCP/FullTcp/Sack/TimelyTCP";
...
for {set i 0} {$i < $T} {incr i} {
        set    number [$r3 value]
	$ns at  [expr $i*$step+0.4+$number] " $tcps(4) advanceby 500"
        set    number [$r3 value]
	$ns at  [expr $i*$step+0.4+$number] " $tcps(5) advanceby 500"
}


$ns at 0.4 "$tcps(0) advanceby 100000"
$ns at 0.4 "$tcps(1) advanceby 100000"
$ns at 0.4 "$tcps(2) advanceby 100000"
$ns at 0.4 "$tcps(3) advanceby 100000"
