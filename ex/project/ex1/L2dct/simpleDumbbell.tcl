...
#       $ns at  [expr $i*$step+0.4] " $tcps($j) get-flow [expr $bytes/$Se]"
# }
#}


$ns at 0.2 "$tcps(0) advanceby 10000"
$ns at 0.2 "$tcps(1) advanceby 10000"
$ns at 0.2 "$tcps(2) advanceby 10000"
$ns at 0.2 "$tcps(3) advanceby 10000"
