...
int main(){
   ...
   sprintf(outputfile,"%s/%s/%s_deadline.result",basepath[0],kind,kind);
  ...
  strcpy(basepath[1],"/home/zhanghan/pfabric-mahanmod/project/ex2/D2TCP");
   ...
   sprintf(outputfile,"%s/%s/%s_deadline.result",basepath[1],kind,kind);
  ...
  strcpy(basepath[2],"/home/zhanghan/pfabric-mahanmod/project/ex2/pFabric");
   ...
   sprintf(outputfile,"%s/%s/%s_deadline.result",basepath[2],kind,kind);
   ...
   sprintf(outputfile,"%s/%s/%s_deadline.result",basepath[3],kind,kind);
   ...
   sprintf(outputfile,"%s/%s/%s_deadline.result",basepath[4],kind,kind);
