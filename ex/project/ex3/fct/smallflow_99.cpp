...
int main(){
   ...
   sprintf(outputfile,"%s/%s/%s_fct99th.result",basepath[0],kind,kind);
   ...
   sprintf(outputfile,"%s/%s/%s_fct99th.result",basepath[1],kind,kind);
   statistics(inputfile,outputfile,kind,basepath[1],x);
     x = 5;

   //For LPD
   strcpy(basepath[2],"/home/zhanghan/pfabric-mahanmod/project/ex2/LPD");
   strcpy(kind,"LPD");
   strcpy(totalkind[2],kind);
   sprintf(outputfile,"%s/%s/%s_fct99th.result",basepath[2],kind,kind);
   statistics(inputfile,outputfile,kind,basepath[2],x);

  //For pFabric
   strcpy(basepath[3],"/home/zhanghan/pfabric-mahanmod/project/ex2/pFabric");
   strcpy(kind,"pFabric");
   strcpy(totalkind[3],kind);
   sprintf(outputfile,"%s/%s/%s_fct99th.result",basepath[3],kind,kind);
  ...
  //For Timely
   ...
   sprintf(outputfile,"%s/%s/%s_fct99th.result",basepath[4],kind,kind);
