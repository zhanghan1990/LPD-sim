...
int main(){
   ...
   statistics(inputfile,outputfile,kind,basepath[0],5);
   ...
   statistics(inputfile,outputfile,kind,basepath[1],5);
   ...
   statistics(inputfile,outputfile,kind,basepath[2],5);
   ...
   statistics(inputfile,outputfile,kind,basepath[3],5);
   ...
   statistics(inputfile,outputfile,kind,basepath[4],5);
