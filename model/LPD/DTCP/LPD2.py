...
plot(x,fluidw1,linestyle='dashed', marker='o',linewidth=3,markerfacecolor='red', markersize=12,label="fluid window1",color='green')
plot(x,nsw1,linestyle='dashed', marker='>',linewidth=3,markerfacecolor='green', markersize=12,label="ns window1",color='green')

plot(x,fluidw2,linestyle='dashed', marker='.',linewidth=3,markerfacecolor='blue', markersize=12,label="fluid window2",color='black')
plot(x,nsw2,linestyle='dashed', marker='>',linewidth=3,markerfacecolor='black', markersize=12,label="ns window2",color='black')
